...
char* IconNames[512];
// 1st index: icon ID
// 2nd index: 0: index for ScanKeys array
//            1: KeyState bitmap (CTRL, ALT, SHIFT)
byte KeyCodes[512][2];
word NIcons;
void LoadMapInterface();
void LoadIcons()
...
SDL_Scancode ScanKeys[NKEYS] = {
	...
	SDL_SCANCODE_PAGEDOWN, SDL_SCANCODE_PAGEUP, SDL_SCANCODE_HOME, SDL_SCANCODE_END, SDL_SCANCODE_INSERT,
